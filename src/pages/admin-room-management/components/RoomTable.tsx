  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column' }}>
      <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        >
          <Tab label="All rooms" sx={tabTextStyle} icon={<Apps sx={tabIconStyle} />} iconPosition="start" disableRipple />
          <Tab
            label="Available"
            sx={tabTextStyle}
        ...
        <TableContainer>
          <Table>
            ...
            <TableBody>
              ...
              >
                <MenuItem onClick={() => setOpenEditRoomModal(true)}>Edit</MenuItem>
                <MenuItem onClick={() => setOpenDeleteRoomModal(true)}>Delete</MenuItem>
              </Menu>
            </TableBody>
          </Table>
        </TableContainer>
