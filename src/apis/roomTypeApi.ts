import { IRoomType, IRoomApiRequest, IRoomTypeApiResponse } from './../types/room';
...
export const roomTypeApi = createApi({
  ...
  endpoints: (builder) => ({
    getRoomTypes: builder.query<IRoomTypeApiResponse, IRoomApiRequest>({
      query: () => ({
        url: '/',
        method: 'GET',
      }),
...
export const { useGetRoomTypesQuery, usePostRoomTypeMutation, usePatchRoomTypeMutation, useDeleteRoomTypeMutation } =
  roomTypeApi;
